...
<head>
    ...
    <link href="/Admin/Views/Layouts/Css/default.css" rel="stylesheet">

    <script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
    function hideURLbar(){ window.scrollTo(0,1); } </script>
    <!-- Meta tag Keywords -->
    <!-- css files -->
    <link rel="stylesheet" href="/Admin/Views/Layouts/Css/style.css" type="text/css" media="all" /> <!-- Style-CSS --> 
    <link rel="stylesheet" href="/Admin/Views/Layouts/Css/font-awesome.css"> <!-- Font-Awesome-Icons-CSS -->
    <!-- //css files -->
    <!-- online-fonts -->
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion position-fixed" id="accordionSidebar" style="    background-image: linear-gradient(45deg, #711f45, #2e83dad6);">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="/Admin/Leds/homeCateId/all">Xem Theo Danh Mục</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseUtilitieskh" class="collapse" aria-labelledby="headingUtilitieskh" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="/Admin/Custummers/home/home">Tất Cả</a>
                                <a class="collapse-item" href="/Admin/Custummers/home/">Thông Tin Khách Hàng</a>
                            </div>
                        </div>
                    </li>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline small text-danger">
                                            <?php echo $_SESSION['name'];?>
                                    </span>
                                    <img class="img-profile rounded-circle" src="/Admin/Views/Imgadmin/<?php echo $_SESSION['img'];?>">
                                </a>
